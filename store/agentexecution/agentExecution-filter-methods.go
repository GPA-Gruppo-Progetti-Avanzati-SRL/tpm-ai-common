...
/*
 * filter-string template: batch_id
 */

// AndBatchIdEqTo No Remarks
func (ca *Criteria) AndBatchIdEqTo(p string) *Criteria {
...
// AndBatchIdIsNullOrUnset No Remarks
func (ca *Criteria) AndBatchIdIsNullOrUnset() *Criteria {
...
func (ca *Criteria) AndBatchIdIn(p []string) *Criteria {
...
// @tpm-schematics:start-region("batch-id-field-filter-section")
// @tpm-schematics:end-region("batch-id-field-filter-section")
